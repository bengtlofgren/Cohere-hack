...
import { Trophy, Star, Briefcase, Mail } from "lucide-react";
...
export function JudgeSearchTool({
  state,
  judges = [],
  error,
}: JudgeSearchToolProps) {
  if (state === "loading") {
    return (
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {error || "Unable to search for judges"}
              </p>
            </div>
          </div>
        </CardHeader>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Found {judges.length} qualified judges
              </p>
            </div>
          </div>
            ...
            <CardContent className="p-4">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <Button
                  size="sm"
                  variant="outline"
                  onClick={() => toast.success(`Email sent to ${judge.name}`)}
                  className="ml-2"
                >
